        ...
        <div style={{ padding: '28px 28px 24px' }}>
          ...
          {submitted ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontWeight: 800, fontSize: 16, color: '#2d3748', marginBottom: 8 }}>Email sent!</p>
              <p style={{ fontSize: 13, color: '#718096', lineHeight: 1.6, marginBottom: 20 }}>
                If an account is linked to that email, we sent your username to your inbox.
              </p>
              <button
                onClick={() => router.push('/login')}
                style={{
                  padding: '12px 28px', background: '#38a169',
            ...
            <>
              <p style={{ fontWeight: 800, fontSize: 16, color: '#2d3748', marginBottom: 4 }}>🪪 Forgot Username</p>
              <p style={{ fontSize: 13, color: '#718096', marginBottom: 20 }}>
                Enter the email you used to sign up and we&apos;ll send your username.
              </p>
